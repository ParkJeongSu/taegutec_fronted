...
function handleConveyorStatus(payload) {
  ...
  console.log('[WorkStation371] 컨베이어 상태 수신:', payload)
}
...
function handlePositionClick(posId) {
  ...
  console.log('[WorkStation371] 트레이 포지션 클릭:', posId)
}
</script>
