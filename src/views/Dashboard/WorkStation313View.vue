      ...
      <div class="d-flex flex-wrap align-center justify-space-between">
        <div class="d-flex align-center">
          ...
          <span class="text-h6 font-weight-bold text-high-emphasis">
            창고 1 &gt; WorkStation 313 모니터링
          </span>
          <v-chip size="small" color="primary" variant="tonal" class="ml-3 font-weight-medium">
            대시보드 &gt; 운영 모니터링 &gt; 창고1 &gt; workstation313
          </v-chip>
          <v-chip
...
const inboundOrders = ref([
  {
    orderNo: 'ORD-IN-313-01',
    trayId: 'TRAY-31301',
    matCode: 'CNMG 120408-TT',
    status: '진행중',
    timestamp: '2026-09-18 09:32:00',
  },
  {
    orderNo: 'ORD-IN-313-02',
    trayId: 'TRAY-31302',
    matCode: 'WNMG 080408-TT',
    status: '대기',
    timestamp: '2026-09-18 09:37:10',
  },
  {
    orderNo: 'ORD-IN-313-03',
    trayId: 'TRAY-31303',
    matCode: 'TNMG 160404-TT',
    status: '대기',
    timestamp: '2026-09-18 09:44:00',
  },
  {
    orderNo: 'ORD-IN-313-04',
    trayId: 'TRAY-31304',
    matCode: 'SNMG 120412-TT',
    status: '대기',
...
const outboundOrders = ref([
  {
    orderNo: 'ORD-OUT-313-01',
    trayId: 'TRAY-31304',
    matCode: 'DNMG 150608-TT',
    status: '진행중',
    timestamp: '2026-09-18 09:30:15',
  },
  {
    orderNo: 'ORD-OUT-313-02',
    trayId: 'TRAY-31305',
    matCode: 'CCMT 09T304-TT',
    status: '대기',
    timestamp: '2026-09-18 09:35:10',
  },
  {
    orderNo: 'ORD-OUT-313-03',
    trayId: 'TRAY-31306',
    matCode: 'VBMT 160404-TT',
    status: '대기',
    timestamp: '2026-09-18 09:47:20',
  },
  {
    orderNo: 'ORD-OUT-313-04',
    trayId: 'TRAY-31307',
    matCode: 'DCMT 11T308-TT',
    status: '대기',
    timestamp: '2026-09-18 09:54:30',
  },
])
...
function handlePositionClick(posId) {
  ...
  console.log('[WorkStation313] 트레이 포지션 클릭:', posId)
}
</script>
