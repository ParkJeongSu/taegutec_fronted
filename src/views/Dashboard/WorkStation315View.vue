      ...
      <div class="d-flex flex-wrap align-center justify-space-between">
        <div class="d-flex align-center">
          ...
          <span class="text-h6 font-weight-bold text-high-emphasis">
            창고 1 &gt; WorkStation 315 모니터링
          </span>
          <v-chip size="small" color="primary" variant="tonal" class="ml-3 font-weight-medium">
            대시보드 &gt; 운영 모니터링 &gt; 창고1 &gt; workstation315
          </v-chip>
          <v-chip
...
const inboundOrders = ref([
  {
    orderNo: 'ORD-IN-315-01',
    trayId: 'TRAY-31501',
    matCode: 'CNMG 120408-CR',
    status: '진행중',
    timestamp: '2026-09-18 09:31:20',
  },
  {
    orderNo: 'ORD-IN-315-02',
    trayId: 'TRAY-31502',
    matCode: 'WNMG 080408-CR',
    status: '대기',
    timestamp: '2026-09-18 09:37:30',
  },
  {
    orderNo: 'ORD-IN-315-03',
    trayId: 'TRAY-31503',
    matCode: 'TNMG 160404-CR',
    status: '대기',
    timestamp: '2026-09-18 09:44:20',
  },
  {
    orderNo: 'ORD-IN-315-04',
    trayId: 'TRAY-31504',
    matCode: 'SNMG 120412-CR',
    status: '대기',
    timestamp: '2026-09-18 09:51:50',
  },
])
...
const outboundOrders = ref([
  {
    orderNo: 'ORD-OUT-315-01',
    trayId: 'TRAY-31504',
    matCode: 'DNMG 150608-CR',
    status: '진행중',
    timestamp: '2026-09-18 09:29:40',
  },
  {
    orderNo: 'ORD-OUT-315-02',
    trayId: 'TRAY-31505',
    matCode: 'CCMT 09T304-CR',
    status: '대기',
    timestamp: '2026-09-18 09:35:20',
  },
  {
    orderNo: 'ORD-OUT-315-03',
    trayId: 'TRAY-31506',
    matCode: 'VBMT 160404-CR',
    status: '대기',
    timestamp: '2026-09-18 09:47:40',
  },
  {
    orderNo: 'ORD-OUT-315-04',
    trayId: 'TRAY-31507',
    matCode: 'DCMT 11T308-CR',
    status: '대기',
    timestamp: '2026-09-18 09:54:10',
  },
])
...
function handlePositionClick(posId) {
  ...
  console.log('[WorkStation315] 트레이 포지션 클릭:', posId)
}
</script>
