      ...
      <div class="d-flex flex-wrap align-center justify-space-between">
        <div class="d-flex align-center">
          ...
          <span class="text-h6 font-weight-bold text-high-emphasis">
            창고 1 &gt; WorkStation 316 모니터링
          </span>
          <v-chip size="small" color="primary" variant="tonal" class="ml-3 font-weight-medium">
            대시보드 &gt; 운영 모니터링 &gt; 창고1 &gt; workstation316
          </v-chip>
          <v-chip
...
const inboundOrders = ref([
  {
    orderNo: 'ORD-IN-316-01',
    trayId: 'TRAY-31601',
    matCode: 'CNMG 120408-HD',
    status: '진행중',
    timestamp: '2026-09-18 09:32:10',
  },
  {
    orderNo: 'ORD-IN-316-02',
    trayId: 'TRAY-31602',
    matCode: 'WNMG 080408-HD',
    status: '대기',
    timestamp: '2026-09-18 09:38:00',
  },
  {
    orderNo: 'ORD-IN-316-03',
    trayId: 'TRAY-31603',
    matCode: 'TNMG 160404-HD',
    status: '대기',
    timestamp: '2026-09-18 09:45:00',
  },
  {
    orderNo: 'ORD-IN-316-04',
    trayId: 'TRAY-31604',
    matCode: 'SNMG 120412-HD',
    status: '대기',
    timestamp: '2026-09-18 09:52:30',
  },
])
...
const outboundOrders = ref([
  {
    orderNo: 'ORD-OUT-316-01',
    trayId: 'TRAY-31604',
    matCode: 'DNMG 150608-HD',
    status: '진행중',
    timestamp: '2026-09-18 09:30:00',
  },
  {
    orderNo: 'ORD-OUT-316-02',
    trayId: 'TRAY-31605',
    matCode: 'CCMT 09T304-HD',
    status: '대기',
    timestamp: '2026-09-18 09:36:00',
  },
  {
    orderNo: 'ORD-OUT-316-03',
    trayId: 'TRAY-31606',
    matCode: 'VBMT 160404-HD',
    status: '대기',
    timestamp: '2026-09-18 09:48:10',
  },
  {
    orderNo: 'ORD-OUT-316-04',
    trayId: 'TRAY-31607',
    matCode: 'DCMT 11T308-HD',
    status: '대기',
...
function handlePositionClick(posId) {
  ...
  console.log('[WorkStation316] 트레이 포지션 클릭:', posId)
}
</script>
