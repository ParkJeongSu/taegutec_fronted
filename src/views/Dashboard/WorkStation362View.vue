      ...
      <div class="d-flex flex-wrap align-center justify-space-between">
        <div class="d-flex align-center">
          ...
          <span class="text-h6 font-weight-bold text-high-emphasis">
            창고 6 &gt; WorkStation 362 모니터링
          </span>
          <v-chip size="small" color="primary" variant="tonal" class="ml-3 font-weight-medium">
            대시보드 &gt; 운영 모니터링 &gt; 창고6 &gt; workstation362
          </v-chip>
          <v-chip
...
function handleConveyorStatus(payload) {
  ...
  console.log('[WorkStation362] 컨베이어 상태 수신:', payload)
}
...
function handlePositionClick(posId) {
  ...
  console.log('[WorkStation362] 트레이 포지션 클릭:', posId)
}
</script>
